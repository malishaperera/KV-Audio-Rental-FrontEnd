  ...
  return (
    <div className="w-[300px] bg-white rounded-lg shadow-lg overflow-hidden m-4 relative">
      ...
      <div className=" flex justify-end h-full p-4 border-t border-gray-200">
        <Link to={'/product/'+item.key} className="w-[90%] h-[40px] text-center bg-blue-500 text-white py-2 rounded-lg hover:bg-blue-600 transition duration-200 absolute mx-auto  bottom-3">
          View Details
        </Link>
      </div>
    </div>
